...
public class Difusor : MonoBehaviour
{
    ...
    [Range(0f, 1f)]
    public float minVol, maxVol;  // volumenes m�ximo y m�nimo establecidos y volumen origintal del source
    ...
    //estos m�todos son usados para desde fuera activar o desactivar el sonido
    void StopSound()
    {
